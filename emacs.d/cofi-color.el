    ...
    (defun color-theme-cofi ()
      ...
      (color-theme-install
       '(color-theme-cofi
         ...
         (diff-context-face ((t (:foreground "grey"))))
         (diff-file-header-face ((t (:foreground "gold"))))
         (diff-function-face ((t (:foreground "grey50"))))
         (diff-header-face ((t (:foreground "gold"))))
         ...
         (font-lock-keyword-face ((t (:bold t :foreground "MediumOrchid" :weight bold))))
         (font-lock-preprocessor-face ((t (:foreground "CadetBlue"))))
         (font-lock-reference-face ((t (:foreground "VioletRed"))))
         (font-lock-string-face ((t (:foreground "Sienna"))))
         (font-lock-type-face ((t (:italic t :foreground "ForestGreen"))))
