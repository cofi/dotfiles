...
(defun cofi/erc-connect-freenode (&optional no-tls)
  (interactive "P")
  (if no-tls
      (erc
...
(defun erc-cmd-RENICK ()
  (erc-message "PRIVMSG" (format "nickserv ghost %s" erc-nick))
